...
void setup() {
  ...
  /* on initialise dans le serveur que la racine est asupppr.html*/
  server.on("/", HTTP_GET, [](AsyncWebServerRequest* request) {
    request->send(SPIFFS, "/base.html");
  });
  /*lorsque l'on met adresseip/admin, on accède */
  ...
  for (int i = 1; i <= 4; i++) {
    ...
    /*Dans la mémoire de la carte on enregistre les données de la distance et de la batterie sous forme de texte
    ex: /bat1 /dist1
    */
